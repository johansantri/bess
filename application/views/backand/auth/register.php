...
<html>
  ...
  <link href="<?php echo base_url()?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <title>SigUp - Bess Project</title>
  </head>
  <body>
          ...
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN UP</h3>
           <div class="row">
            <div class="col">
              ...
              <input type="text" class="form-control" name="nama_depan" placeholder=" " required >
            </div>
            <div class="col">
               <label class="control-label">LAST NAME</label>
              <input type="text" class="form-control" name="nama_belakang" placeholder=" " required >
            </div>
          </div>

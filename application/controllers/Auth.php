    ...
    {  
        ...
        public function sigup()
        {
            ...
            $config = Array(  
                    ...
                    $this->email->cc('kirimcek@gmai.com');   //email sesuaikan
                    ...
                    echo '<div class="alert alert-success alert-dismissible" role="alert">
                          ...
                          <strong> <span class="glyphicon glyphicon-ok-sign"></span> </strong>sukses,cek email anda
                        </div>';
                     return  
                     
                     redirect(site_url().'auth/login'); //redirect();
                    }  
                    exit;                    
            ...
            if($this->form_validation->run() == FALSE) {
                ...
                echo $message; //send this through mail
                  ...
                  $config = Array(  
                    ...
                    echo '<div class="alert alert-success alert-dismissible" role="alert">
                          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                          <strong> <span class="glyphicon glyphicon-ok-sign"></span> </strong>sukses
                        </div>';
                     return  
